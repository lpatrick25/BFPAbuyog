                ...
                <div class="col animate__animated animate__fadeIn" data-wow-delay="0.5s">
                    <div class="iq-card bg-white">
                        ...
                        <div class="iq-card-body text-center p-3">
                            ...
                            <h4 class="counter text-dark">{{ $metrics['completed_inspections'] }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col animate__animated animate__fadeIn" data-wow-delay="0.7s">
                    <div class="iq-card bg-white">
                        <div class="iq-card-header bg-info text-white">
                        ...
                        <div class="iq-card-body text-center p-3">
                            ...
                            <h4 class="counter text-dark">{{ $metrics['active_users'] }}</h4>
                        </div>
                    </div>
                </div>
            </div>
