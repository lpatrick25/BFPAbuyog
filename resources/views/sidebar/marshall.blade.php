...
<li class="nav-item">
    <a class="nav-link @yield('marshall-dashboard')" aria-current="page" href="{{ route('marshall.dashboard') }}">
        <i class="icon">
...
<li class="nav-item">
    <a class="nav-link @yield('marshall-gis')" aria-current="page" href="{{ route('marshall.mapping') }}">
        <i class="icon">
...
<li class="nav-item">
    <a class="nav-link @yield('marshall-establishment')" aria-current="page" href="{{ route('marshall.establishments') }}">
        <i class="icon">
...
<li class="nav-item">
    <a class="nav-link @yield('marshall-application')" aria-current="page" href="{{ route('applicant.list') }}">
        <i class="icon">
...
<li class="nav-item">
    <a class="nav-link @yield('marshall-fsic')" aria-current="page" href="{{ route('fsic.list') }}">
        <i class="icon">
...
<li class="nav-item">
    <a class="nav-link @yield('marshall-reports')" aria-current="page" href="{{ route('reports.list') }}">
        <i class="icon">
            <!-- Bootstrap Icon: bar-chart (for Reports) -->
            <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor"
                xmlns="http://www.w3.org/2000/svg" class="icon-20">
                <path
